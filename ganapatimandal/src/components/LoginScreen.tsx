...
export default function LoginScreen({ onSwitch }: { onSwitch: () => void }) {
  const { login, serverIp, serverPort, updateServerIp } = useAuth();
        ...
        <ThemedView style={styles.container}>
          ...
          <View style={styles.header}>
            ...
            <ThemedText type="title" style={styles.title}>
              साईप्रसाद कला, क्रीडा व सांस्कृतिक मित्र मंडळ
            </ThemedText>
            <ThemedText style={styles.subtitle} themeColor="textSecondary">
              Ganeshotsav Accounts & Management
            </ThemedText>
          </View>
          ...
          <ThemedView type="backgroundElement" style={styles.card}>
            ...
            <Pressable style={styles.switchButton} onPress={onSwitch}>
              <ThemedText type="small" style={styles.switchText}>
                New volunteer? <ThemedText type="smallBold" style={{ color: theme.primary }}>Register Here</ThemedText>
              </ThemedText>
            </Pressable>
          </ThemedView>
